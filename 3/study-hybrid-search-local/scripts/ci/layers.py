...
FORBIDDEN_RULES: list[tuple[str, list[str]]] = [
    ...
    (
        ...
        ["app.services.adapters", "google.cloud", "lightgbm", "psycopg"],
    ),
    ("app/services/ranking.py", ["app.services.adapters", "google.cloud", "lightgbm", "psycopg"]),
    ("app/services/feedback_service.py", ["app.services.adapters", "google.cloud", "psycopg"]),
